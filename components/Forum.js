...
export default function Forum() {
    ...
    const handleSend = async () => {
        console.log("Forum.js: handleSend triggered");
        if (!user) {
            ...
            <div className="max-w-4xl mx-auto px-4">
                    ...
                    {!user ? (
                        ...
                        <div className="space-y-6">
                            <textarea
                                ...
                                className="w-full border border-white/5 rounded-3xl p-6 text-sm focus:border-primary-500 outline-none transition-all resize-none min-h-[120px]"
                                style={{ backgroundColor: 'var(--color-input-bg)', color: 'var(--color-text)' }}
                            />
                            <div className="flex items-center justify-between">
                                <span className="text-[10px] font-black uppercase tracking-widest" style={{ color: 'var(--color-text-muted)' }}>Autor: {user.email}</span>
                                <button 
                                    onClick={handleSend}
                ...
                <div className="mt-20 text-center">
                    ...
                    <div className="flex justify-center gap-6 flex-wrap">
                        <a href={siteConfig.communityLinks.telegram} target="_blank" rel="noopener noreferrer" className="btn-3d px-8 py-4 text-sm flex items-center gap-3 shadow-lg" style={{ background: '#0088cc', color: 'white', borderColor: 'rgba(255,255,255,0.2)' }}>
                        ...
                        <a href={siteConfig.communityLinks.whatsapp} target="_blank" rel="noopener noreferrer" className="btn-3d px-8 py-4 text-sm flex items-center gap-3 shadow-lg" style={{ background: '#25D366', color: 'white', borderColor: 'rgba(255,255,255,0.2)' }}>
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
