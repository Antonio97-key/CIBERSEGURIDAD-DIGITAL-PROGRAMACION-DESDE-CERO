...
export default function Community() {
    ...
    const [dynamicLinks, setDynamicLinks] = useState({ discord: '#', whatsapp: '#' });
            ...
            <div className="section-container">
                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="relative overflow-hidden rounded-2xl p-1 bg-gradient-to-r from-[#5865F2] to-[#4752C4] shadow-lg transform transition-transform hover:-translate-y-1">
                            <div className="bg-white dark:bg-carbon-900 rounded-xl p-6 flex flex-col items-center text-center gap-4 relative z-10 h-full">
                                <div className="flex-shrink-0 w-16 h-16 bg-[#5865F2]/10 dark:bg-[#5865F2]/20 rounded-full flex items-center justify-center">
                                    {/* Discord Icon */}
                                ...
                                <div className="flex-1 flex flex-col">
                                    <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">Comunidad Discord</h3>
                                    ...
                                    <a
                                        href={dynamicLinks.discord}
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="inline-flex items-center justify-center gap-2 bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold py-2 px-6 rounded-full transition-colors w-full"
                                    >
                                        Unirse al Servidor
                                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
